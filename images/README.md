...
| `biscoito-provolone.jpg` | produto *Biscoito Provolone* |
...
| `pao-de-queijo-temperado.jpg` | Pão de queijo com cheiro-verde e calabresa, um partido ao meio | **Prioridade alta.** Foto real do temperado com calabresa — hoje é o único tempero do catálogo. |
...
- **2026-08-10** — quatro fotos de produto foram geradas depois de pesquisar o que
  cada item realmente é. Descobertas que valem manter: o *biscoito provolone* não é pão de
  queijo comum, e *broa* aqui é **broinha de fubá** (rolinho redondo de ~30 g), não
  um bolo fatiado.
- **2026-08-18** — o cliente mandou fotos reais. Entraram tradicional, biscoito provolone,
  recheado, o pacote, a fachada da loja e a assadeira no forno; as versões geradas
  desses foram apagadas. A foto real confirmou que o **biscoito provolone é alongado**, com
...
- **2026-09-16** — *Provolito* passou a se chamar **Biscoito Provolone** (arquivo
  renomeado junto) e o **pão de queijo temperado ficou só com calabresa**; o tempero
  da casa saiu do catálogo.
...
- Fotos de cada **broa** (doce, erva-doce, temperada): as três dividem uma foto de
  conjunto, e o card não troca a imagem quando o cliente escolhe outro sabor
